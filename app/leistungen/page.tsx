        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 md:gap-16 items-start min-h-[70vh] mb-16 lg:mb-0">
            ...
            <div className="order-1 lg:order-2">
              <h4 className="text-6xl md:text-8xl font-bold text-white mb-8 text-center lg:text-right">Mix & Mastering</h4>
            </div>
          </div>
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 md:gap-16 items-start min-h-[70vh] mb-16 lg:mb-0">
            <div className="order-1 lg:order-1">
              <h4 className="text-6xl md:text-8xl font-bold text-white mb-8 text-center lg:text-left">Musik-produktion</h4>
            </div>
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 md:gap-16 items-start min-h-[70vh] mb-16 lg:mb-0">
            ...
            <div className="order-1 lg:order-2">
              <h4 className="text-6xl md:text-8xl font-bold text-white mb-8 text-center lg:text-right">Live</h4>
            </div>
          </div>
        </div>
      </section>
