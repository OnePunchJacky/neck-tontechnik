          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:info@neck-tontechnik.com" className="text-gray-300 hover:text-white transition-colors">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <a href="tel:+4915123456789" className="text-gray-300 hover:text-white transition-colors">
                        +49 151 234 567 89
                      </a>
                    </div>
                  </div>
              ...
              <div className="bg-zinc-800 rounded-lg p-6">
                <h3 className="text-white font-bold text-xl mb-4">Meine Services</h3>
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-center">
                    ...
                    <p className="text-gray-300 text-sm">Musikproduktion</p>
                  </div>
                  <div className="text-center">
                    <div className="w-12 h-12 bg-blue-600 rounded-lg mx-auto mb-2 flex items-center justify-center">
                      <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <p className="text-gray-300 text-sm">Mixing & Mastering</p>
                  </div>
                  <div className="text-center">
                    <div className="w-12 h-12 bg-blue-600 rounded-lg mx-auto mb-2 flex items-center justify-center">
                      <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <p className="text-gray-300 text-sm">Live-Tontechnik</p>
                  </div>
                  <div className="text-center">
                    <div className="w-12 h-12 bg-blue-600 rounded-lg mx-auto mb-2 flex items-center justify-center">
                      <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <p className="text-gray-300 text-sm">Workshops</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-blue-600 rounded-lg p-6 text-center">
                <h3 className="text-white font-bold text-lg mb-2">Schnelle Antwort garantiert</h3>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            <div className="bg-zinc-900 rounded-lg p-6">
              <h3 className="text-white font-semibold mb-2">Wie läuft ein Recording-Projekt ab?</h3>
            ...
            <div className="bg-zinc-900 rounded-lg p-6">
              <h3 className="text-white font-semibold mb-2">Was kostet eine Live-Beschallung?</h3>
              <p className="text-gray-300 text-sm">
            ...
            <div className="bg-zinc-900 rounded-lg p-6">
              <h3 className="text-white font-semibold mb-2">Arbeitest du auch remote?</h3>
              <p className="text-gray-300 text-sm">
