...
function AudioPlayer({ beforeUrl, afterUrl, title, duration }: AudioPlayerProps) {
  ...
  return (
    <div className="bg-[var(--color-surface)] rounded-lg p-6">
      <h3 className="text-[var(--color-text-primary)] font-semibold text-lg mb-4">{title}</h3>
      ...
      {/* Track Selector */}
      <div className="flex mb-4 bg-[var(--color-surface-light)] rounded-lg p-1">
        <button
      ...
      <div className="space-y-4">
        <div className="flex items-center space-x-4">
          <button
            ...
            className="w-12 h-12 bg-[var(--color-accent-blue)] hover:bg-[var(--color-accent-blue)] rounded-full flex items-center justify-center transition-colors"
          >
            {isPlaying ? (
              <svg className="w-6 h-6 text-[var(--color-text-primary)]" fill="currentColor" viewBox="0 0 24 24">
                <path d="M6 4h4v16H6V4zm8 0h4v16h-4V4z"/>
              </svg>
            ) : (
              <svg className="w-6 h-6 text-[var(--color-text-primary)] ml-1" fill="currentColor" viewBox="0 0 24 24">
...
export default function MasteringPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--color-bg)]">
      ...
      {/* How to Use Section */}
      <section className="py-12 px-4 md:px-8 bg-[var(--color-surface)]">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-2xl font-bold text-[var(--color-text-primary)] mb-6">So funktioniert's</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              <div className="w-12 h-12 bg-[var(--color-accent-blue)] rounded-full mx-auto mb-3 flex items-center justify-center">
                <span className="text-[var(--color-text-primary)] font-bold">1</span>
              </div>
              <h3 className="text-[var(--color-text-primary)] font-semibold mb-2">Auswählen</h3>
      ...
      <section className="py-16 px-4 md:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          {loading ? (
            ...
            <div className="text-center py-12">
              <p className="text-[var(--color-text-muted)] text-lg">Keine Audio-Beispiele gefunden.</p>
            </div>
          ) : (
      ...
      <section className="bg-[var(--color-surface)] py-16 px-4 md:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="w-16 h-16 bg-[var(--color-accent-green)] rounded-lg mx-auto mb-4 flex items-center justify-center">
              ...
              <h3 className="text-[var(--color-text-primary)] font-bold text-lg mb-2">Optimale Lautstärke</h3>
              <p className="text-[var(--color-text-secondary)] text-sm">
                Deine Tracks erreichen kommerzielle Lautstärke ohne Verzerrungen
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-[var(--color-accent-blue)] rounded-lg mx-auto mb-4 flex items-center justify-center">
                <svg className="w-8 h-8 text-[var(--color-text-primary)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
              </div>
              <h3 className="text-[var(--color-text-primary)] font-bold text-lg mb-2">Mehr Energie</h3>
              <p className="text-[var(--color-text-secondary)] text-sm">
                Kompression und EQ verleihen deiner Musik mehr Durchsetzungskraft
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-[var(--color-accent-purple)] rounded-lg mx-auto mb-4 flex items-center justify-center">
                <svg className="w-8 h-8 text-[var(--color-text-primary)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <h3 className="text-[var(--color-text-primary)] font-bold text-lg mb-2">Konsistenz</h3>
              <p className="text-[var(--color-text-secondary)] text-sm">
                Alle Tracks eines Albums klingen einheitlich und ausgewogen
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-[var(--color-accent-red)] rounded-lg mx-auto mb-4 flex items-center justify-center">
                <svg className="w-8 h-8 text-[var(--color-text-primary)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="text-[var(--color-text-primary)] font-bold text-lg mb-2">Klarheit</h3>
              <p className="text-[var(--color-text-secondary)] text-sm">
                Jedes Element im Mix wird deutlicher und präsenter
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-[var(--color-accent-yellow)] rounded-lg mx-auto mb-4 flex items-center justify-center">
                <svg className="w-8 h-8 text-[var(--color-text-primary)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
                </svg>
              </div>
              <h3 className="text-[var(--color-text-primary)] font-bold text-lg mb-2">Streaming-Ready</h3>
              <p className="text-[var(--color-text-secondary)] text-sm">
                Optimiert für Spotify, Apple Music und andere Streaming-Plattformen
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-[var(--color-secondary)] rounded-lg mx-auto mb-4 flex items-center justify-center">
                <svg className="w-8 h-8 text-[var(--color-text-primary)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
                </svg>
              </div>
              <h3 className="text-[var(--color-text-primary)] font-bold text-lg mb-2">Emotionale Wirkung</h3>
              <p className="text-[var(--color-text-secondary)] text-sm">
