...
function register_testimonials_post_type()
{
    ...
    $args = array(
        ...
        'show_in_nav_menus'     => true,
        'can_export'            => true,
        'has_archive'           => false, // Testimonials don't need archive
        'exclude_from_search'   => false,
        'publicly_queryable'    => true,
        'capability_type'       => 'post',
...
// Register Custom Post Type for Homepage Logos (Carousel)
function register_homepage_logos_post_type()
{
    $labels = array(
        'name'                  => _x('Homepage Logos', 'Post Type General Name', 'text_domain'),
        'singular_name'         => _x('Homepage Logo', 'Post Type Singular Name', 'text_domain'),
        'add_new_item'          => __('Add New Logo', 'text_domain'),
        'add_new'               => __('Add Logo', 'text_domain'),
    );
    $args = array(
        'label'                 => __('Homepage Logo', 'text_domain'),
        'labels'                => $labels,
    ...
    register_post_type('homepage_logo', $args);
}
add_action('init', 'register_homepage_logos_post_type', 0);
